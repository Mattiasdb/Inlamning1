...
CREATE TABLE Kunder (
    ...
    Epost VARCHAR(255) UNIQUE NOT NULL,	-- UNIQUE betyder här att all Epost måste vara unika i tabellen
...
*/
CREATE TABLE Böcker (
    BokID INT AUTO_INCREMENT PRIMARY KEY, -- PRIMARY KEY gör kolumnen till en unik identifierare för varje rad
...
CREATE TABLE Beställningar (
    ...
    KundID INT NOT NULL,                                            
    Datum TIMESTAMP DEFAULT CURRENT_TIMESTAMP, -- Datum och tid, om inget värde ges så sätts det aktuella datumet och tiden
    ...
    );                                             -- refererar att KundID finnas som primary key i tabellen Kunder
/*
